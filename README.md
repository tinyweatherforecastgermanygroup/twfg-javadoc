...
4. run [`javadoc`](https://www.oracle.com/java/technologies/javase/javadoc.html) against the code repositories java files -> the [uml-java-doclet](https://github.com/gboersma/uml-java-doclet) by Gerald Boersma ([@gboersma](https://github.com/gboersma/uml-java-doclet)) is used instead of the default doclet to produce **UML** diagrams during the process.
5. copy generated html assets to `public` directory

## Dependencies

* **OpenJDK 11** (contained in `openjdk:11-jdk` docker image)
* [uml-java-doclet](https://github.com/gboersma/uml-java-doclet) -> **graphviz**
* **brotli** -> compression of assets (js, css, images)
...
The [**uml-java-doclet**](https://github.com/gboersma/uml-java-doclet) by Gerald Boersma ([@gboersma](https://github.com/gboersma/uml-java-doclet)) uses [graphviz](https://gitlab.com/graphviz/graphviz) via [PlantUML](https://plantuml.com/).
